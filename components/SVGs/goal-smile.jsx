...
const GoalSmile = () => {
  return (
    <div className="goal-container flex items-start gap-3 mt-2">
      ...
      <div className="mt-1">
        <div className={`${styles['goal-text']}`}>
          ...
          <p className="text-base font-semibold text-black">Better understand yourself</p>
        </div>
      </div>
    </div>
  );
