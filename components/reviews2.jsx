...
const Review2 = ({ stars, username, date, review, initials, color }) => (
  <div className="bg-white bg-opacity-90 rounded-lg p-3 mb-3 text-sm border-2 border-gray-300">
